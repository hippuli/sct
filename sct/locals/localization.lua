...
SCT.LOCALS.Ready = "ready";			  		-- Message to be displayed when cooldown is finished
SCT.LOCALS.ComboPoint = "CP";			  		-- Message to be displayed when gaining a combo point
SCT.LOCALS.CPMaxMessage = "Finish It!"; -- Message to be displayed when you have max combo points
