...
SCT.OPTIONS.FrameEventFrames [SCT.LOCALS.OPTION_EVENT27.name] = { index = 27, tooltipText = SCT.LOCALS.OPTION_EVENT27.tooltipText, SCTVar = "SHOWCOOLDOWNS"};
...
SCT.OPTIONS.FrameSliders [SCT.LOCALS.OPTION_SLIDER19.name] = { index = 19, SCTVar = "CDFILTER", minValue = 0, maxValue = 600, valueStep = 10, minText=SCT.LOCALS.OPTION_SLIDER19.minText, maxText=SCT.LOCALS.OPTION_SLIDER19.maxText, tooltipText = SCT.LOCALS.OPTION_SLIDER19.tooltipText};
...
SCT.OPTIONS.FrameSelections [SCT.LOCALS.OPTION_SELECTION10.name] = { index = 10, SCTVar = "CDBLACKWHITELIST", tooltipText = SCT.LOCALS.OPTION_SELECTION10.tooltipText, table = SCT.LOCALS.OPTION_SELECTION10.table};
...
SCT.OPTIONS.FrameMisc [SCT.LOCALS.OPTION_MISC36.name] = {index = 36, tooltipText = SCT.LOCALS.OPTION_MISC36.tooltipText}
...
SCT.OPTIONS.EditBoxes [SCT.LOCALS.OPTION_EDITBOX6.name] = { index = 6, SCTVar = "CDLIST", tooltipText = SCT.LOCALS.OPTION_EDITBOX6.tooltipText};
